// --------------------------------------------------------------------------
// <copyright file="OdbcHubSpotForeignKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.HubSpot.Tools
{
  internal sealed class OdbcHubSpotForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
