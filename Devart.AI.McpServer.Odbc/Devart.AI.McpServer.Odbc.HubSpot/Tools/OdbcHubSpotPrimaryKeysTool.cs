// --------------------------------------------------------------------------
// <copyright file="OdbcHubSpotPrimaryKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcHubSpotPrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
